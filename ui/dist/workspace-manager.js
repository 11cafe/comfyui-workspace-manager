...
var Mi = ux(!0), cx = ux(!1), Ds = {}, Mr = Vn(Ds), ls = Vn(Ds), us = Vn(Ds);
function so(e) {
  if (e === Ds)
    throw Error(O(174));
  return e;
...
function fp(e, t, r, n, o) {
  ...
  return i = Ai(t, i), yi(t, o), r = Uh(e, t, r, n, i, o), n = Hh(), e !== null && !Pt ? (t.updateQueue = e.updateQueue, t.flags &= -2053, e.lanes &= ~o, on(e, t, o)) : (Oe && n && Mh(t), t.flags |= 1, gt(e, t, r, o), t.child);
}
function zg(e, t, r, n, o) {
  ...
  if (yi(t, o), t.stateNode === null)
    ...
    typeof u == "object" && u !== null ? u = or(u) : (u = Et(r) ? xo : mt.current, u = Ai(t, u));
    ...
    a = t.stateNode, ax(e, t), s = t.memoizedProps, u = t.type === t.elementType ? s : fr(t.type, s), a.props = u, d = t.pendingProps, f = a.context, l = r.contextType, typeof l == "object" && l !== null ? l = or(l) : (l = Et(r) ? xo : mt.current, l = Ai(t, l));
...
var S2 = Math.ceil, Du = un.ReactCurrentDispatcher, qh = un.ReactCurrentOwner, tr = un.ReactCurrentBatchConfig, ae = 0, et = null, He = null, st = 0, zt = 0, ri = Vn(0), qe = 0, ps = null, ko = 0, xc = 0, Xh = 0, Da = null, Ct = null, Qh = 0, zi = 1 / 0, Vr = null, Fu = !1, Sp = null, Rn = null, bl = !1, _n = null, Lu = 0, Fa = 0, wp = null, Xl = -1, Ql = 0;
function xt() {
...
function gr(e, t, r, n) {
  ...
  Os(e, r, n), (!(ae & 2) || e !== et) && (e === et && (!(ae & 2) && (xc |= r), qe === 4 && Sn(e, st)), $t(e, n), r === 1 && ae === 0 && !(t.mode & 1) && (zi = Be() + 500, vc && Wn()));
}
function $t(e, t) {
...
function Kx(e, t) {
  ...
  if (n & 30 || n & e.expiredLanes || t)
    ...
    ae |= 2;
    var i = qx();
    (et !== e || st !== t) && (Vr = null, zi = Be() + 500, co(e, t));
    do
      try {
        C2();
        break;
...
function Hg(e, t, r) {
  t = Ii(r, t), t = Rx(e, t, 1), e = An(e, t, 1), t = xt(), e !== null && (Os(e, 1, t), $t(e, t));
}
function je(e, t, r) {
  if (e.tag === 3)
    Hg(e, e, r);
    ...
    for (; t !== null; ) {
      if (t.tag === 3) {
        ...
        if (typeof t.type.getDerivedStateFromError == "function" || typeof n.componentDidCatch == "function" && (Rn === null || !Rn.has(n))) {
          e = Ii(r, e), e = Mx(t, e, 1), t = An(t, e, 1), e = xt(), t !== null && (Os(t, 1, e), $t(t, e));
          break;
        }
      }
      t = t.return;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        r !== 0 && (Ch(t, r | 1), $t(t, Be()), !(ae & 6) && (zi = Be() + 500, Wn()));
      }
      break;
    case 13:
      Co(function() {
...
}), { definePartsStyle: qS, defineMultiStyleConfig: Vz } = _e(cR.keys), Ci = W("avatar-border-color"), Wa = W("avatar-bg"), Ss = W("avatar-font-size"), Li = W("avatar-size"), Wz = {
  borderRadius: "full",
  border: "0.2em solid",
...
function t4(e, t, r) {
  ...
  if (a)
    for (let s = 0; s < a; s++) {
      const l = i[s], u = t[l];
      let c = null;
      Array.isArray(u) && (c = u[0]), c === null && (c = (o = (n = r[l]) !== null && n !== void 0 ? n : e.readValue(l)) !== null && o !== void 0 ? o : t[l]), c != null && (typeof c == "string" && (ok(c) || nk(c)) ? c = parseFloat(c) : !ZF(c) && Nn.test(u) && (c = rk(l, u)), e.addValue(l, ji(c, { owner: e })), r[l] === void 0 && (r[l] = c), c !== null && e.setBaseTarget(l, c));
    }
}
function r4(e, t) {
...
function V8({ onclose: e, loadWorkflowID: t }) {
      ...
      children: [
        ...
        /* @__PURE__ */ k.jsxs(gv, { children: [
          ...
          /* @__PURE__ */ k.jsxs(xv, { children: [
            ...
            r.map((i) => /* @__PURE__ */ k.jsxs(go, { w: "100%", justify: "space-between", children: [
              /* @__PURE__ */ k.jsxs(
                td,
                {
                  gap: 0,
                  ...
                  children: [
                    /* @__PURE__ */ k.jsx(Ei, { fontWeight: "500", children: i.name ?? "untitled" }),
                    /* @__PURE__ */ k.jsxs(Ei, { color: "GrayText", ml: 2, fontSize: "sm", children: [
                      "Updated: ",
                      W8(i.updateTime)
                    ] })
                  ]
              ...
              /* @__PURE__ */ k.jsx(XC, { children: ({ isOpen: a, onClose: s }) => /* @__PURE__ */ k.jsxs(k.Fragment, { children: [
                ...
                /* @__PURE__ */ k.jsxs(t_, { children: [
                  ...
                  /* @__PURE__ */ k.jsxs(ZC, { children: [
                    /* @__PURE__ */ k.jsx(Ei, { mb: 4, fontWeight: 600, children: "Are you sure you want to delete this workflow?" }),
                    /* @__PURE__ */ k.jsx(
                      vo,
                      {
                        colorScheme: "red",
...
function K8() {
  const [e, t] = b.useState([]), r = b.useRef({}), n = b.useRef(null), [o, i] = b.useState(null), [a, s] = b.useState("root"), l = () => {
    ...
    const f = {
      ...
      async setup(g) {
        console.log("ext.setup", g);
      },
      async addCustomNodeDefs(g) {
        console.log("addCustomNodeDefs in workspace manager", g), r.current = g;
      }
      // async loadedGraphNode(node: LGraphNode, app: ComfyApp) {},
    };
    Nl.registerExtension(f);
    const p = localStorage.getItem("curFlowID");
    if (console.log("latest", p), p)
      n.current = p;
    else {
      const g = localStorage.getItem("workflow"), x = U1(g ?? "");
      console.log("created new flow", x), n.current = x.id;
    }
    i(((m = yr[n.current]) == null ? void 0 : m.name) ?? ""), setTimeout(() => {
      const g = H8();
      t(g);
    }, 1e3);
  };
  b.useEffect(() => {
    l(), setInterval(() => {
      if (console.log("interval curflowid", n.current), n.current != null) {
        const f = localStorage.getItem("workflow");
        localStorage.setItem("curFlowID", n.current), f != null && W1(n.current, {
          json: f
        });
      }
    }, 1e3);
  ...
  const u = (f) => {
    ...
    n.current = f;
    const p = yr[f];
    i(p.name), Nl.loadGraphData(JSON.parse(p.json)), s("root");
  };
  return /* @__PURE__ */ k.jsxs(
    uv,
    {
              ...
              /* @__PURE__ */ k.jsxs(go, { children: [
                ...
                /* @__PURE__ */ k.jsx(
                  lv,
                  {
                    ...
                    value: o ?? "",
                    onChange: (f) => {
                      i(f.target.value), c(f.target.value);
                    }
                  }
                ),
                /* @__PURE__ */ k.jsx(
                  vo,
                  {
                    leftIcon: /* @__PURE__ */ k.jsx(a_, { size: 16 }),
                    size: "sm",
                    onClick: () => {
                      const f = G8, p = U1(JSON.stringify(f));
                      console.log("created new flow", p), n.current = p.id, i(p.name), Nl.loadGraphData(f);
                    },
                    children: "New"
                  }
                )
              ] }),
              /* @__PURE__ */ k.jsx(go, { children: /* @__PURE__ */ k.jsx(
                vo,
                {
                  colorScheme: "gray",
                  onClick: () => {
...
function Y8({
  ...
  b.useEffect(() => {
    ...
    console.log("nodeIDs", f), fetch("/workspace/find_nodes", {
      ...
      console.log("search_nodes res", p), a(p.filter((m) => m != null)), o(p.filter((m) => m != null).map((m) => m.id));
    });
  }, [e]);
  const d = async (f) => {
    var p;
      ...
      children: [
        ...
        /* @__PURE__ */ k.jsxs(gv, { children: [
          ...
          /* @__PURE__ */ k.jsxs(xv, { children: [
            ...
            /* @__PURE__ */ k.jsx(Ei, { mb: 3, color: "GrayText", fontSize: "small", children: "Unselectable nodes are not found in Github, they may be private repos" }),
            e.map((f) => {
